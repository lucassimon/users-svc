...
Rswag::Ui.configure do |c|
  ...
  Settings.api.docs.versions.each do |api_version|
    c.swagger_endpoint api_version.endpoint, api_version.description
  end

  # Add Basic Auth in case your API is private
  c.basic_auth_enabled = true
  c.basic_auth_credentials Settings.api.docs.auth.username, Settings.api.docs.auth.password
end
